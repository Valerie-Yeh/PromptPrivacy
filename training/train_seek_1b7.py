...
# load dataset
df = pd.read_csv('../dataset_gen/train.csv', encoding='utf-8')
#input = df[['hide_model560m', 'hide_model560m_trans', 'content']]
#output = df['turboRef_gpt4_trans']
...
output_directory = os.path.join("../cache_gen", "seek_outputs")
...
peft_model_path = os.path.join(output_directory, 'model_1b7')
